...
$currentAdmin = $roleResult->fetch_assoc();
$roleStmt->close();
...
$result = $conn->query("SELECT id, first_name, last_name, email, department, role, created_at FROM hr_admins ORDER BY created_at ASC");
...
echo json_encode(["success" => true, "data" => $admins, "current_admin_id" => $currentAdminId]);
